...
class MinesweeperCell:
	# Можливі стани ігрової клітини:
	# closed - закрита
	# opened - відкрита
	# flagged - позначена прапорцем
	# questioned - позначена знаком питання
...
class MinesweeperView( Frame ):
    def __init__( self, model, controller, parent = None ):
        ...
        Button( panel, text = 'Нова гра', command = self.controller.startNewGame ).pack( side = RIGHT )
        ...
        Label( panel, text = ' Кількість мін: ' ).pack( side = RIGHT )
        ...
        Label( panel, text = 'Розмір поля: ' ).pack( side = RIGHT )
    ...
    def showWinMessage( self ):
        showinfo( 'Вітаю!', 'Ви перемогли!' )

    def showGameOverMessage( self ):
        showinfo( 'Гра закінчена!', 'Ви програли!' )
